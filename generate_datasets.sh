...
python3 datasets/prepare_dataset.py \
    --video_folder=datasets/loaded_harmonic \
    ...
    --stride=36 \
    --crop \
    --scene_changes=datasets/scene_changes_harmonic.json \
    --block_min_std=20.0
python3 datasets/prepare_div2k_dataset.py \
    --div2k_folder=datasets/loaded_div2k/train \
    --dataset_folder=datasets/train_div2k \
    --type=blocks \
    --temporal_radius=1 \
    --block_size=36 \
    --stride=36
python3 datasets/prepare_div2k_dataset.py \
    --div2k_folder=datasets/loaded_div2k/test \
    --dataset_folder=datasets/test_div2k \
    --type=full \
    --temporal_radius=1
